...
#
#	rustc.sh
#		Build the rustc compiler binary and package in tarball.
#
# =========================================================================
#
# @author Jay Wheeler.
...
# =========================================================================
#
#    rc_Archive - create an archive of the installed rustc compiler
#
#	Entry:
...
{
	lmsDisplay
	lmsDisplayTs "  Installing existing rustc compiler"
	lmsDisplay
	...
	lmsDisplay
	lmsDisplayTs "Existing rustc compiler installed."
	lmsDisplay
