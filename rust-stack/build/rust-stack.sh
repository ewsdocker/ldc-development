...
#
# ===========================================================================
cd ~/Development/ewsldc/ldc-development/rust-stack
...
echo "   ********************************************"
echo "   ****"
echo "   **** removing rust-stack image"
echo "   ****"
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-development:rust-stack-0.1.0-b4 > /dev/null 2>&1

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-development:rust-stack-0.1.0-b4 image "
echo "   ****"
echo "   ***************************************************"
echo
...
docker build \
  ...
  --build-arg BUILD_VERSION="rust-stack" \
  ...
  \
  --file Dockerfile \
-t ewsdocker/ldc-development:rust-stack-0.1.0-b4 .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-development:rust-stack-0.1.0-b4 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** created ldc-development-rust-stack-0.1.0-b4"
echo "   ****"
echo "   ***********************************************"
echo
